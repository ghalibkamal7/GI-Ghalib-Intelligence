...
function FloatingAssistantButton({ onOpen }) {
  ...
  return (
    <motion.button
      ...
      className="adjustable bottom-24 sm:bottom-8 right-4 sm:right-6 z-30 w-14 h-14 rounded-full glass-strong border border-indigo-500/30 flex items-center justify-center shadow-2xl"
    >
      <motion.div
