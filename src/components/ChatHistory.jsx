      ...
      <div className="max-w-3xl mx-auto">
          ...
          {image && (
            ...
            >
              ...
              <button
                ...
                className="absolute -top-2 -right-2 w-5 h-5 rounded-full bg-red-500 flex items-center justify-center text-white shadow-md hover:bg-red-600 transition-colors"
              >
                <X size={11} />
              </button>
            </motion.div>
        ...
        <div className="flex items-end gap-2 glass rounded-2xl px-4 py-3 border border-white/10 focus-within:border-indigo-500/50 transition-colors duration-200">
          ...
          <button
            ...
            className="p-1.5 rounded-xl text-slate-500 hover:text-indigo-400 hover:bg-indigo-500/10 transition-all shrink-0 mb-0.5"
            title="Attach image"
          >
            <ImagePlus size={18} />
          </button>
        ...
        <p className="text-center text-slate-700 text-xs mt-2">
          GI can make mistakes. Double-check important info.
        </p>
      </div>
    </div>
  );
